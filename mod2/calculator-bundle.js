...
var calulator = new calculator_1["default"]();
...
function getData(x) {
    return new Promise(function (resolve) {
        setTimeout(function () { return resolve(x); }, 1000);
    });
}
getData(100).then(function (e) { return console.log(e); });
function doStuff() {
    return __awaiter(this, void 0, void 0, function () {
        var x;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getData(42)];
                case 1:
                    x = _a.sent();
                    console.log(x);
                    return [2 /*return*/];
